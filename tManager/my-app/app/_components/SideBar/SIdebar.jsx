...
// }
  ...
  export default function SIdebar() {
    return (
      <aside className="bg-gradient-to-r from-[#F5BCBA] to-[#C3C7FE] border sm:w-52 w-5 items-center flex flex-col md:justify-between justify-around p-6 rounded-l-3xl transition-all duration-300 ease-in-out">
       
          <div className="flex items-center space-x-4">
            <Image src="/metaverse.png" alt="Profile" width={40} height={40} className="rounded-full" />
            <span className="font-bold sm:block hidden">Talhism</span>
          </div>
          <nav className="space-y-4">
            <NavLink href="/" icon={<FaHome />} text="Home" />
            <NavLink href="/Tasks" icon={<FaUser />} text="Tasks" />
            <NavLink href="/CompletedTasks" icon={<FaCog />} text="Complete Task" />
            <NavLink href="/Dashboard" icon={<FaEnvelope />} text="Dashboard" />
          </nav>
