...
const HomePage = () => {
  return (
    <div className='flex flex-col items-center bg-clip-text'>
      ...
      <div className='text-gray-800 max-w-[740px] text-[16px] leading-[22px] md:text-[19px] md:leading-[26px] lg:text-[22px] lg:leading-[36px] md:font-medium mt-4 px-8 text-center'>
      ...
      <motion.div
            ...
            <div className='w-full bg-[#6a818d] sm:h-[120px] h-fit py-4 flex items-center justify-around sm:flex-row flex-col'>
