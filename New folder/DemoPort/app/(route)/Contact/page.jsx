...
const RegistrationForm = () => {
        ...
        <div className="min-w-screen min-h-screen  flex items-center justify-center px-5 py-5">
            <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style={{ maxWidth: '1000px' }}>
                <div className="md:flex w-full">
                    <div className="hidden md:block w-1/2 bg-gradient-to-tr from-[#FF512F] to-[#DD2476] py-10 px-10">
                        {/* SVG Image */}
                    ...
                    <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div className="text-center mb-10">
                            ...
                            <p>Feel free to discuss any query with me !</p>
                        </div>
    ...
    <div className="flex">
        ...
        />
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5">
                                    <button type="submit" className="block w-full max-w-xs mx-auto bg-gradient-to-tr from-[#FF512F] to-[#DD2476] text-white rounded-lg px-3 py-3 font-semibold">Send NOW</button>
                                </div> 
                            </div>
                        </form>
                    </div>
